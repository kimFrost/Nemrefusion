...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			...
			nemrefusion: {
				src: [
					'js/angular.nemrefusion.js',
					'js/nemrefusion.angular.controllers.js'
				],
				dest: '../scripts/nemrefusion.js'
			}
		},
		uglify: {
			options: {
			...
			nemrefusion: {
				src: '<%= concat.nemrefusion.dest %>',
				dest: '../scripts/nemrefusion.min.js'
			}
		},
		compass: {
			dist: {
